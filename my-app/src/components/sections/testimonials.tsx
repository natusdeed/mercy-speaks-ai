...
interface TestimonialsProps {
  items?: Testimonial[];
  /** Overrides default website-focused heading when used on industry/service pages */
  title?: string;
  description?: string;
  /** Single primary CTA instead of website + portfolio buttons */
...
export function Testimonials({
  items,
  title = "What clients say about our website work",
    ...
    <section className="section relative overflow-hidden" aria-labelledby="testimonials-title">
      <div className="section-inner relative z-10 max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-slate-400 max-w-3xl mx-auto">{description}</p>
        </motion.div>

        {testimonials.length > 0 ? (
          <div
            className={
              singleCardLayout && testimonials.length === 1
                ? "grid grid-cols-1 max-w-2xl mx-auto gap-5 md:gap-6"
